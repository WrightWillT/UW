...
To examine the relationship between sample sizes, power, and equal/unequal variance we investigated 3 conditions.  When assuming equal variance, we use the variance from the temp = 100 condition.  When assuming unequal variance, we use the modeled variance from the linear model above.
...
4. Assuming a t-distribution with equal variance using a T-statistic (Welch's T-test)
